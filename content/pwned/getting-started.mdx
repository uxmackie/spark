...
For mobile **AdGuard Premium** / iOS or [**Rethink DNS**](https://rethinkdns.com/app), and you can block YouTube and Reddit ads with [**Morphe**](https://morphe.software/), which you can optionally [set up easily](https://wispydocs.pages.dev/morphe-piko-obtainium/). Note that uBO works on mobile browsers like Firefox too.
...
Many popular file hosts have download buttons that redirect to fake malicious download pages. Using the full version of uBlock Origin can prevent this but it doesn't always work. Read this [guide](https://cs.rin.ru/forum/viewtopic.php?f=14&t=159345) to learn what fake malicious download pages look like and how to avoid them. A general rule is to avoid download pages that open in a new tab or a redirected page, real downloads happen within the same page as the file host.
...
- **Audiobooks: [Mobilism Audiobooks](https://forum.mobilism.org/viewforum.php?f=124) / [AudiobookBay](https://audiobookbay.lu/)**
...
[Source](https://github.com/fmhy/edit/blob/main/docs/.vitepress/notes/audiobookbay-warning.md)
</Info>
